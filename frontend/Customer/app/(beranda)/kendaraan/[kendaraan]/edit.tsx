/**
 * app/(beranda)/kendaraan/[kendaraanId]/edit.tsx
 *
 * Screen edit kendaraan — ambil data existing lalu isi form.
 */
...
import { useGetAllKendaraan, useUpdateKendaraanMutation, useGetKendaraanById } from "../../../../src/hooks/kendaraan.hooks";
import { KendaraanForm } from "../../../../src/components/kendaraan/kendaraanForm";
 ...
 export default function KendaraanEditScreen() {
   const { kendaraanId } = useLocalSearchParams<{ kendaraanId: string }>();
   const [errorMessage, setErrorMessage] = useState<string | null>(null);
 
   // Ambil data existing untuk isi initialValues form
   ...
   // Loading saat ambil data existing
   if (isLoading) {
     return (
   ...
   // Bentuk initialValues dari data existing
